<?php
    ...
    $id = $_GET['id'];
    $created_by = $_SESSION["username_admin"];
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables.php?file=list-news.php">List News</a>
                        <a class="collapse-item active" href="tables.php?file=list-barang.php">List Barang</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="cek-edit-barang.php" method="post" class="user">
