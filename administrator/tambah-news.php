        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Adding News</h1>
                    <form action="cek-tambah-news.php" method="post" class="user">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <textarea type="text" class="form-control form-control-user" id="deskripsi"
                                placeholder="Deskripsi Berita" name="deskripsi" rows="2" cols="50"></textarea>
                        </div>
